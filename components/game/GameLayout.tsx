      ...
      <header className="glass-card-strong relative z-20 flex items-center justify-between mx-4 mt-3 mb-1 rounded-lg border px-4 py-2 sm:px-6 md:mx-6 md:mt-4 md:mb-2 md:px-6 xl:mx-0 xl:mt-0 xl:mb-0 xl:rounded-none xl:border-x-0 xl:border-t-0 xl:px-6">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center justify-center p-1.5 rounded hover:bg-neutral-100 dark:hover:bg-neutral-800 border border-transparent hover:border-neutral-200 dark:hover:border-neutral-700 transition-colors focus-visible:ring-1 focus-visible:ring-neutral-900 dark:focus-visible:ring-neutral-100 focus-visible:outline-none"
            aria-label={soundEnabled ? "Mute audio" : "Unmute audio"}
            title={soundEnabled ? "Mute audio" : "Unmute audio"}
          >
            {soundEnabled ? (
              <Volume2 className="h-4 w-4 text-neutral-800 dark:text-neutral-200" />
            ) : (
